    ...
    public void testNextKeyValue() throws Exception {
        ...
        while (recordReader.nextKeyValue()) {
            ...
            if (start == 1) {
                ...
                assertEquals("Date not equal","Tue Jun 19 07:06:45 WEST 2012", currDate.toString());
            ...
            if (start == 195) {
                ...
                assertEquals("Date Type not equal","Tue Jun 19 07:09:09 WEST 2012", currDate.toString());
            ...
            if (start == 379) {
                ...
                assertEquals("Date Type not equal","Tue Jun 19 07:11:21 WEST 2012", currDate.toString());
                assertEquals("HTTPrc not equal",-1, currHTTPrc);
    ...
    public void testIAHNextKeyValue() throws Exception {
        ...
        while (recordReader.nextKeyValue()) {
            ...
            if (start == 1) {
                ...
                assertEquals("Response type not equal","warcinfo", currType);
                assertEquals("URL not equal",null, currURL);
                assertEquals("Date not equal","Wed Apr 30 20:48:25 WEST 2008", currDate.toString());
                assertEquals("HTTPrc not equal",-1, currHTTPrc);
            ...
            if (start == 195) {
                ...
                assertEquals("Date Type not equal","Wed Apr 30 20:49:12 WEST 2008", currDate.toString());
                assertEquals("HTTPrc not equal",-1, currHTTPrc);
            ...
            if (start == 379) {
                ...
                assertEquals("Date Type not equal","Wed Apr 30 20:50:15 WEST 2008", currDate.toString());
                assertEquals("HTTPrc not equal",-1, currHTTPrc);
                assertEquals("Length Type not equal",0, currLength);
                assertEquals("Content seems not to be correct",0, myContentStringIndex);
            }
